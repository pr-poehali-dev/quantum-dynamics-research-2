        ...
        <div className="grid gap-8 md:grid-cols-[1.2fr_1fr] md:gap-16 lg:gap-24">
          <div className="flex flex-col justify-center">
            ...
            >
              ...
              <p className="font-mono text-xs text-foreground/60 md:text-base">/ Расскажите нам о нём</p>
            </div>
            ...
            <div className="space-y-4 md:space-y-8">
              ...
              >
                <div className="mb-1 flex items-center gap-2">
                  ...
                  <span className="font-mono text-xs text-foreground/60">Страна</span>
                </div>
          ...
          <div className="flex flex-col justify-center">
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6">
              ...
              <div
                ...
                style={{ transitionDelay: "500ms" }}
              >
                <label className="mb-1 block font-mono text-xs text-foreground/60 md:mb-2">Расскажите о герое</label>
                <textarea
                  rows={3}
                  ...
                  required
                  className="w-full border-b border-foreground/30 bg-transparent py-1.5 text-sm text-foreground placeholder:text-foreground/40 focus:border-foreground/50 focus:outline-none md:py-2 md:text-base"
                  placeholder="Имя, звание, история, ссылка на фото..."
                />
              </div>
              ...
              >
                ...
                >
                  {isSubmitting ? "Отправка..." : "Предложить героя"}
                </MagneticButton>
                {submitSuccess && (
